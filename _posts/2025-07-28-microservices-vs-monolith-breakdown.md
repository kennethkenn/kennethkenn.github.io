...
Don't start with microservices. Start with a **Modular Monolith**. Keep your code separated by packages. If you can't build a modular monolith, building microservices will just lead to a "Distributed Monolith" — the worst of both worlds.
